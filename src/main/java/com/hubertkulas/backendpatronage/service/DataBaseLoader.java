...
public class DataBaseLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        conferenceRoomRepository.save(new ConferenceRoom("BlueRoom", "10", 1, true, 20, 30, 0,
                new ConferenceRoomEquipment("Alfa", true, 56, "+12 687123123")));
        conferenceRoomRepository.save(new ConferenceRoom("BlueWall", "20", 2, true, 20, 10, 0,
                new ConferenceRoomEquipment("Beta", true, 31, "+14 123456789")));
        conferenceRoomRepository.save(new ConferenceRoom("OrangeRoom", "22", 2, true, 15, 5, 0,
                new ConferenceRoomEquipment("Gamma", true, 12, "+12 147103103")));
        conferenceRoomRepository.save(new ConferenceRoom("WideRoom", "40", 4, false, 15, 8, 6,
